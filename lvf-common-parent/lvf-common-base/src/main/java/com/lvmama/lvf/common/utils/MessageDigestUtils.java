...
public class MessageDigestUtils {
	...
	public static byte[] sha(String data) throws UnsupportedEncodingException {
	...
	public static byte[] sha512(String data) throws UnsupportedEncodingException {
	...
	public static String sha512Hex(String data) throws UnsupportedEncodingException {
		return encodeHexString(sha512(data));
	}
