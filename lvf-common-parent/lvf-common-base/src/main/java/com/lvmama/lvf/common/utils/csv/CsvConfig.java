...
public abstract class CsvConfig{
	...
	public static CsvConfig TICKET_DETAIL_LIST = new CsvConfig("客票明细列表")
	{
		...
		public String getHead() 
		{
			return "票号,机票状态,PNR,航程,航班号,乘机时间,乘机人,乘客类型,应收款,支付方式,下单时间,渠道,政策类型,供应商,订单号";
		}
	};
	...
	public static CsvConfig ORDER_REQ_RECORD_LIST = new CsvConfig("下单请求列表"){
		@Override
		public String getHead(){
			return " 下单请求时间 , traceNo,订单号,订单来源 , 预定结果 ,原始供应商,原始信息, 信息 , 耗时, 始发地代码 , 目的地代码 ,"
					+ "航班号 , 舱位 , 乘机日期,供应商 , 供应商政策号 , 票面价 , 结算价 , 燃油 , 机建 , 订单总销售价 ,乘客人数 ,"
					+ "驴妈妈帐号名 ,账号类型, 联系人姓名 , 联系人手机号 ";
		}
	};
	...
	public static CsvConfig FINANCIAL_REPORT_LIST = new CsvConfig("财务对账报表")
	{
		@Override
		public String getHead() 
		{
		    return "主订单号,支付订单号/退款订单号,子单号, 收支类型(客人),支付时间/退款时间,收支流水号,收支流水金额,虚拟收支流水号,虚拟收支流水金额,付款流水号," 
		          +"付款流水金额,订单类型,支付状态,支付方式,下单时间,供应商,供应商订单号,销售渠道,航空公司,"
				+"起飞时间,到达时间,机票总结算价,机票总销售价,机票总利润,保险总结算价,保险总销售价,保险总利润,直减金额,应收款,实收款,产品类型";
		}
	};
