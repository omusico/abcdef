		...
		<div class="traffic_list">
			...
			<ul class="info_ul">
				...
				<li class="info_li3">
					...
					<p class="fh_ap_name"><em>${arvFlightInfo.departureTermainalBuilding}</em><span>T2</span></p>
				</li>
				<li class="info_li4">
			...
			<!-- 差价 -->
			<div class="info_li8 fh_chajia">+<span class="fh_price"><dfn>¥</dfn>235</span></div>
			<!-- 选择按钮 -->
			<div class="info_li9 fh_btn">
				<span class="btn btn-small btn-orange js_fh_select">选择</span>
