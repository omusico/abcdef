...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			{
	    		return  "<a href='http://super.lvmama.com/vst_back/selfTour/prod/product/showProductMaintain.do?productId="+cellvalue+"' target='_blank' style='color:blue;'>"+cellvalue+ "</a>";
    		}
			...
			/**
	  		...
	  		function exportCsv(){
				...
				url +="&cancelFlag="+$("#cancelFlag").val();
				url +="&saleFlag="+$("#saleFlag").val();
