...
import com.lvmama.lvfit.common.dto.status.PayStatusType;
 ...
 * @date   2015-1-30
 */
public enum OrderPayStatus implements FitGeneratorOp,FitProcessOp {
...
//            }
	...
	public void processOp(StatusContext statusContext) {
		...
		if(vaild(statusContext)){
			statusContext.getOrder().getOrderStatus().setOrderPayStatus(this);
		}
	};
}
