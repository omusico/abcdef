...
public class FlightPaymentUrlDto implements Serializable{
	 ...
	 /**	订单支付 等待时间.	默认30分钟	 */
	 private String waitPayment = "30";
	 /**	是否必须预授权支付		 */
	 boolean hasNeedPrePay = false ;
	 /**	是否可以预授权支付		 */
	 boolean prepayAble = false ;
	 /**	签名		 */
	...
	/**	 机票侧的支付成功或失败状态	 */
	private ResultStatus flightPaymentStatus;
	...
	public ResultStatus getFlightPaymentStatus() {
		return flightPaymentStatus;
	}
	public void setFlightPaymentStatus(ResultStatus flightPaymentStatus) {
		this.flightPaymentStatus = flightPaymentStatus;
	}
}
