...
public class Distributor implements Serializable {
	...
	public Distributor(Long distributorInfoId, String distributorCode,
			String distributorName, String distributorKey, String channelCode,
			String isRegisterUser, String isPushUpdate, String isAddNewprod) {
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((distributorInfoId == null) ? 0 : distributorInfoId
						.hashCode());
		return result;
	}
