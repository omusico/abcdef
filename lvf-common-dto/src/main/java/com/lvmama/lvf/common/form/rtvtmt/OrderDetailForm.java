package com.lvmama.lvf.common.form.rtvtmt;
 ...
 * @date   2015-4-9
 */
public class OrderDetailForm implements Serializable,Form {
	
	private static final long serialVersionUID = -7344548205154956581L;
	
	private FlightOrderDetailDto flightOrderDetail = new FlightOrderDetailDto();
	
	public OrderDetailForm() {}
	
	public OrderDetailForm(FlightOrderDetailDto flightOrderDetail)
	{
		this.setFlightOrderDetail(flightOrderDetail);
	}
	...
	public void setIsCanIssue(boolean isCanIssue) {
		flightOrderDetail.setIsCanIssue(isCanIssue);
	}

	public boolean getIsCanIssue() {
		return flightOrderDetail.getIsCanIssue();
	}

	public void setIsCanRTVT(boolean isCanRTVT) {
		flightOrderDetail.setIsCanRTVT(isCanRTVT);
	}

	public boolean getIsCanRTVT() {
		return flightOrderDetail.getIsCanRTVT();
	}

	public void setIsCanCTMT(boolean isCanCTMT) {
		flightOrderDetail.setIsCanCTMT(isCanCTMT);
	}

	public boolean getIsCanCTMT() {
		return flightOrderDetail.getIsCanCTMT();
	}
