...
/**
 * CTMT改期改签信息ResponseForm
 * 
 * @author yuanweihong
 * @date 2015-4-8
 */
public class TicketCTMTResponseForm implements Serializable, Form {

	private static final long serialVersionUID = -5976773190584475036L;
	...
	public TicketCTMTResponseForm() {
		super();
	}

	public TicketCTMTResponseForm(SeatClass seatClass) {
		super();
	...
	public void setSeatClassType(SeatClassType seatClassType) {
		seatClass.setSeatClassType(seatClassType);
	}
